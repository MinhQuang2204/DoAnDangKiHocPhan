...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        string strConnect = "Data Source = (local); Initial Catalog = QUANLYSV; Integrated Security = True";

        public void changeStrConnectToSinhVien()
        {
            strConnect = "Data Source = (local); Initial Catalog = QUANLYSV; Persist Security Info = True; User ID = sinhvien; Password = sinhvien";
